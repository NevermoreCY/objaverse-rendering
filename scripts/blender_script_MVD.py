...
# 4 x4 camera extrinsic parameters, could also save intrinsic para.
...
# setup lighting
bpy.data.worlds["World"].node_tree.nodes["Background"].inputs[1].default_value = 30
#
...
#     initial_azimuth = (random.randint(0,32)) / 32 * 360
#     # azimuth = random.uniform(0., 360)
#     distance = random.uniform(1.4, 1.6)
#     return set_camera_location(elevation, initial_azimuth, distance)
#
# def change_azimuth():
